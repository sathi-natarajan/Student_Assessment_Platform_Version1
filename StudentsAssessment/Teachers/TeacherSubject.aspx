...
<body>
    ...
    <div id="Content">
            ...
            <tr>
                <td valign="top">
                    ...
                    <div id="divListClassesTaught_TeacherSubject" >
                        <strong>Select a class to add subject to:<br />
                        </strong>
                ...
                <td valign="top">
                    ...
                    <div id="divListSubjects">
                        <strong>Select a subject to add to selected class:<br />
                        </strong>
                        <asp:PlaceHolder ID="SubjectsHolder" runat="server"></asp:PlaceHolder>
                    </div>
                </td>
                <td valign="top">
                    <div style="height:35px;background-color:mediumpurple;color:white;">
                        <strong>SUBJECTS ALREADY TAUGHT BY <asp:Label ID="lblTeachername1" runat="server"></asp:Label></strong>
                    </div>
                    <div id="divListSSubjectsAlreadyTaughtBy">
        ...
        ForeColor="White" BackColor="darkgreen">ADD SUBJECT TO CLASS</asp:LinkButton>&nbsp;&nbsp;&nbsp;
                  <asp:LinkButton ID="lnkRemoveSubject" runat="server" Font-bold="true" Font-Underline="false" 
        ForeColor="White" BackColor="darkgreen">REMOVE SUBJECT FROM CLASS</asp:LinkButton>&nbsp;&nbsp;&nbsp;
                </td>
                  <td>
